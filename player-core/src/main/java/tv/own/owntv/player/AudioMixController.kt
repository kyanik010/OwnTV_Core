...
/**
 * Holds the state of an external IPTV audio source.
 *
 * The actual libmpv commands are intentionally handled by OwnTVPlayer,
 * because all libmpv calls must run through its mpvAsync executor.
 */
